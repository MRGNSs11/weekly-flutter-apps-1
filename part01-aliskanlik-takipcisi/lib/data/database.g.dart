...
class Completion extends DataClass implements Insertable<Completion> {
  final int habitId;
  final int dayKey;
  const Completion({required this.habitId, required this.dayKey});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
  ...
  CompletionsCompanion toCompanion(bool nullToAbsent) {
    return CompletionsCompanion(habitId: Value(habitId), dayKey: Value(dayKey));
  }
  ...
  Completion copyWith({int? habitId, int? dayKey}) => Completion(
